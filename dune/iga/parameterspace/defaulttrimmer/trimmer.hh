...
#include <dune/iga/parameterspace/identitytrimmer/patchgridlocalgeometry.hh>
...
namespace DefaultTrim {
  ...
  /**
   * @brief Trimmer struct representing a parameterspace with identity trimming (no trimming at all).
   * @ingroup Trimmer
   * @tparam dim Dimension of the patch.
   * @tparam ScalarType Scalar type for the coordinates.
   */
